...
const Nav = () => {
  ...
  return (
    <header>
      ...
      <div className='hidden py-[30px] px-12 items-center justify-between md:flex'>
        ...
        <nav>
          <ul className='flex items-center justify-between gap-x-12'>
            <li><Link className='nav__link text-base font-semibold capitalize px-6 py-3 hover:text-green-800' to='/'>Home</Link></li>
            <li><Link className='nav__link text-base font-semibold capitalize px-6 py-3 hover:text-green-800' to='/wallet'>Wallet</Link></li>
            <li><Link className='nav__link text-base font-semibold capitalize px-6 py-3 hover:text-green-800' to='/transactions'>Transactions</Link></li>
            <li><Link className='nav__link text-base font-semibold capitalize px-6 py-3 hover:text-green-800' to='/beneficiaries'>Beneficiaries</Link></li>
            <li><Link className='nav__link text-base font-semibold capitalize px-6 py-3 hover:text-green-800' to='/analytics'>Analytics</Link></li>
          </ul>
        </nav>
        <div>
